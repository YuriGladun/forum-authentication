...
func main() {
	...
	app.GitHubClientID = os.Getenv("GITHUB_CLIENT_ID")
	app.GitHubClientSecret = os.Getenv("GITHUB_CLIENT_SECRET")

	app.GoogleClientID = os.Getenv("GOOGLE_CLIENT_ID")
	app.GoogleClientSecret = os.Getenv("GOOGLE_CLIENT_SECRET")
